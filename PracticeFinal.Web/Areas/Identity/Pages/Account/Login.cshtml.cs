...
namespace PracticeFinal.Web.Areas.Identity.Pages.Account
{
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<IdentityUser> signInManager, ILogger<LoginModel> logger, IConfiguration appsettings)
        {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                Microsoft.AspNetCore.Identity.SignInResult result = await Utils.SignIn(Input.Email, Input.Password, _appsettings, HttpContext);
                if (result.Succeeded)
                {
